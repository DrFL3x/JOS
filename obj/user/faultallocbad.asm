...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  80013c:	e8 56 00 00 00       	call   800197 <vcprintf>
	cprintf("\n");
  800141:	c7 04 24 81 13 80 00 	movl   $0x801381,(%esp)
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  800d86:	a1 04 20 80 00       	mov    0x802004,%eax
  800d8b:	8b 40 48             	mov    0x48(%eax),%eax
  800d8e:	83 ec 04             	sub    $0x4,%esp
  800d91:	6a 07                	push   $0x7
  ...
  800da3:	78 29                	js     800dce <set_pgfault_handler+0x61>
		r = sys_env_set_pgfault_upcall(0, _pgfault_upcall);
  800da5:	83 ec 08             	sub    $0x8,%esp
  800da8:	68 e1 0d 80 00       	push   $0x800de1
  800dad:	6a 00                	push   $0x0
  800daf:	e8 13 ff ff ff       	call   800cc7 <sys_env_set_pgfault_upcall>
		if (r < 0)
  800db4:	83 c4 10             	add    $0x10,%esp
  800db7:	85 c0                	test   %eax,%eax
  800db9:	79 c1                	jns    800d7c <set_pgfault_handler+0xf>
			cprintf("sys_env_set_pgfault_upcall: %d\n", r);
  800dbb:	83 ec 08             	sub    $0x8,%esp
  800dbe:	50                   	push   %eax
  800dbf:	68 84 13 80 00       	push   $0x801384
  800dc4:	e8 1f f4 ff ff       	call   8001e8 <cprintf>
  800dc9:	83 c4 10             	add    $0x10,%esp
  800dcc:	eb ae                	jmp    800d7c <set_pgfault_handler+0xf>
			cprintf("sys_page_alloc: %d\n", r);
  800dce:	83 ec 08             	sub    $0x8,%esp
  800dd1:	50                   	push   %eax
  800dd2:	68 6f 13 80 00       	push   $0x80136f
  800dd7:	e8 0c f4 ff ff       	call   8001e8 <cprintf>
  800ddc:	83 c4 10             	add    $0x10,%esp
  800ddf:	eb c4                	jmp    800da5 <set_pgfault_handler+0x38>
...
_pgfault_upcall:
  ...
  800de2:	a1 08 20 80 00       	mov    0x802008,%eax
	call *%eax
  ...
  800de9:	83 c4 04             	add    $0x4,%esp
	...
	movl 0x28(%esp), %ebx
  800dec:	8b 5c 24 28          	mov    0x28(%esp),%ebx
	movl 0x30(%esp), %ecx
  800df0:	8b 4c 24 30          	mov    0x30(%esp),%ecx
	subl $0x4, %ecx
  800df4:	83 e9 04             	sub    $0x4,%ecx
	movl %ebx, (%ecx)
  800df7:	89 19                	mov    %ebx,(%ecx)
	movl %ecx, 0x30(%esp)
  800df9:	89 4c 24 30          	mov    %ecx,0x30(%esp)
