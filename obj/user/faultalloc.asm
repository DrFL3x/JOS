...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800151:	e8 56 00 00 00       	call   8001ac <vcprintf>
	cprintf("\n");
  800156:	c7 04 24 81 13 80 00 	movl   $0x801381,(%esp)
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  800d9b:	a1 04 20 80 00       	mov    0x802004,%eax
  800da0:	8b 40 48             	mov    0x48(%eax),%eax
  ...
  800db8:	78 29                	js     800de3 <set_pgfault_handler+0x61>
		r = sys_env_set_pgfault_upcall(0, _pgfault_upcall);
  800dba:	83 ec 08             	sub    $0x8,%esp
  800dbd:	68 f6 0d 80 00       	push   $0x800df6
  800dc2:	6a 00                	push   $0x0
  800dc4:	e8 13 ff ff ff       	call   800cdc <sys_env_set_pgfault_upcall>
		if (r < 0)
  800dc9:	83 c4 10             	add    $0x10,%esp
  800dcc:	85 c0                	test   %eax,%eax
  800dce:	79 c1                	jns    800d91 <set_pgfault_handler+0xf>
			cprintf("sys_env_set_pgfault_upcall: %d\n", r);
  800dd0:	83 ec 08             	sub    $0x8,%esp
  800dd3:	50                   	push   %eax
  800dd4:	68 84 13 80 00       	push   $0x801384
  800dd9:	e8 1f f4 ff ff       	call   8001fd <cprintf>
  800dde:	83 c4 10             	add    $0x10,%esp
  800de1:	eb ae                	jmp    800d91 <set_pgfault_handler+0xf>
			cprintf("sys_page_alloc: %d\n", r);
  800de3:	83 ec 08             	sub    $0x8,%esp
  800de6:	50                   	push   %eax
  800de7:	68 6f 13 80 00       	push   $0x80136f
  800dec:	e8 0c f4 ff ff       	call   8001fd <cprintf>
  800df1:	83 c4 10             	add    $0x10,%esp
  800df4:	eb c4                	jmp    800dba <set_pgfault_handler+0x38>

00800df6 <_pgfault_upcall>:
...
_pgfault_upcall:
  ...
  800df7:	a1 08 20 80 00       	mov    0x802008,%eax
	call *%eax
  ...
  800dfe:	83 c4 04             	add    $0x4,%esp
	...
	movl 0x28(%esp), %ebx
  800e01:	8b 5c 24 28          	mov    0x28(%esp),%ebx
	movl 0x30(%esp), %ecx
  800e05:	8b 4c 24 30          	mov    0x30(%esp),%ecx
	subl $0x4, %ecx
  800e09:	83 e9 04             	sub    $0x4,%ecx
	movl %ebx, (%ecx)
  800e0c:	89 19                	mov    %ebx,(%ecx)
	movl %ecx, 0x30(%esp)
  800e0e:	89 4c 24 30          	mov    %ecx,0x30(%esp)
