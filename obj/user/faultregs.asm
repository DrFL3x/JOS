...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  8012b2:	a1 cc 20 80 00       	mov    0x8020cc,%eax
  ...
  8012cf:	78 29                	js     8012fa <set_pgfault_handler+0x61>
		r = sys_env_set_pgfault_upcall(0, _pgfault_upcall);
  8012d1:	83 ec 08             	sub    $0x8,%esp
  8012d4:	68 0d 13 80 00       	push   $0x80130d
  8012d9:	6a 00                	push   $0x0
  8012db:	e8 13 ff ff ff       	call   8011f3 <sys_env_set_pgfault_upcall>
		if (r < 0)
  8012e0:	83 c4 10             	add    $0x10,%esp
  8012e3:	85 c0                	test   %eax,%eax
  8012e5:	79 c1                	jns    8012a8 <set_pgfault_handler+0xf>
			cprintf("sys_env_set_pgfault_upcall: %d\n", r);
  8012e7:	83 ec 08             	sub    $0x8,%esp
  8012ea:	50                   	push   %eax
  8012eb:	68 44 19 80 00       	push   $0x801944
  8012f0:	e8 1f f4 ff ff       	call   800714 <cprintf>
  8012f5:	83 c4 10             	add    $0x10,%esp
  8012f8:	eb ae                	jmp    8012a8 <set_pgfault_handler+0xf>
			cprintf("sys_page_alloc: %d\n", r);
  8012fa:	83 ec 08             	sub    $0x8,%esp
  8012fd:	50                   	push   %eax
  8012fe:	68 2f 19 80 00       	push   $0x80192f
  801303:	e8 0c f4 ff ff       	call   800714 <cprintf>
  801308:	83 c4 10             	add    $0x10,%esp
  80130b:	eb c4                	jmp    8012d1 <set_pgfault_handler+0x38>
...
_pgfault_upcall:
  ...
  80130e:	a1 d0 20 80 00       	mov    0x8020d0,%eax
	call *%eax
  ...
  801315:	83 c4 04             	add    $0x4,%esp
	...
	movl 0x28(%esp), %ebx
  801318:	8b 5c 24 28          	mov    0x28(%esp),%ebx
	movl 0x30(%esp), %ecx
  80131c:	8b 4c 24 30          	mov    0x30(%esp),%ecx
	subl $0x4, %ecx
  801320:	83 e9 04             	sub    $0x4,%ecx
	movl %ebx, (%ecx)
  801323:	89 19                	mov    %ebx,(%ecx)
	movl %ecx, 0x30(%esp)
  801325:	89 4c 24 30          	mov    %ecx,0x30(%esp)
