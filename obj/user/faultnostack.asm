...
_pgfault_upcall:
  ...
  800322:	8b 5c 24 28          	mov    0x28(%esp),%ebx
	movl 0x30(%esp), %ecx
  800326:	8b 4c 24 30          	mov    0x30(%esp),%ecx
	subl $0x4, %ecx
  80032a:	83 e9 04             	sub    $0x4,%ecx
	movl %ebx, (%ecx)
  80032d:	89 19                	mov    %ebx,(%ecx)
	movl %ecx, 0x30(%esp)
  80032f:	89 4c 24 30          	mov    %ecx,0x30(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  80036c:	e8 56 00 00 00       	call   8003c7 <vcprintf>
	cprintf("\n");
  800371:	c7 04 24 b6 12 80 00 	movl   $0x8012b6,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8004c0:	0f be 80 5b 10 80 00 	movsbl 0x80105b(%eax),%eax
  8004c7:	50                   	push   %eax
...
0080050f <vprintfmt>:
{
  ...
  800653:	52                   	push   %edx
  800654:	68 7c 10 80 00       	push   $0x80107c
  800659:	53                   	push   %ebx
  80065a:	56                   	push   %esi
  ...
  80066b:	50                   	push   %eax
  80066c:	68 73 10 80 00       	push   $0x801073
  800671:	53                   	push   %ebx
  800672:	56                   	push   %esi
  ...
  800693:	b8 6c 10 80 00       	mov    $0x80106c,%eax
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  800d4b:	a1 04 20 80 00       	mov    0x802004,%eax
  ...
  800d68:	78 29                	js     800d93 <set_pgfault_handler+0x61>
		r = sys_env_set_pgfault_upcall(0, _pgfault_upcall);
  800d6a:	83 ec 08             	sub    $0x8,%esp
  800d6d:	68 17 03 80 00       	push   $0x800317
  800d72:	6a 00                	push   $0x0
  800d74:	e8 f8 f4 ff ff       	call   800271 <sys_env_set_pgfault_upcall>
		if (r < 0)
  800d79:	83 c4 10             	add    $0x10,%esp
  800d7c:	85 c0                	test   %eax,%eax
  800d7e:	79 c1                	jns    800d41 <set_pgfault_handler+0xf>
			cprintf("sys_env_set_pgfault_upcall: %d\n", r);
  800d80:	83 ec 08             	sub    $0x8,%esp
  800d83:	50                   	push   %eax
  800d84:	68 b8 12 80 00       	push   $0x8012b8
  800d89:	e8 8a f6 ff ff       	call   800418 <cprintf>
  800d8e:	83 c4 10             	add    $0x10,%esp
  800d91:	eb ae                	jmp    800d41 <set_pgfault_handler+0xf>
			cprintf("sys_page_alloc: %d\n", r);
  800d93:	83 ec 08             	sub    $0x8,%esp
  800d96:	50                   	push   %eax
  800d97:	68 a4 12 80 00       	push   $0x8012a4
  800d9c:	e8 77 f6 ff ff       	call   800418 <cprintf>
  800da1:	83 c4 10             	add    $0x10,%esp
  800da4:	eb c4                	jmp    800d6a <set_pgfault_handler+0x38>
