...
sys_env_destroy(envid_t envid)
{
  ...
  800b00:	e8 87 02 00 00       	call   800d8c <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800b81:	e8 06 02 00 00       	call   800d8c <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800bc3:	e8 c4 01 00 00       	call   800d8c <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800c05:	e8 82 01 00 00       	call   800d8c <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800c47:	e8 40 01 00 00       	call   800d8c <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800c89:	e8 fe 00 00 00       	call   800d8c <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800ced:	e8 9a 00 00 00       	call   800d8c <_panic>
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  800d28:	78 29                	js     800d53 <set_pgfault_handler+0x61>
		r = sys_env_set_pgfault_upcall(0, _pgfault_upcall);
  800d2a:	83 ec 08             	sub    $0x8,%esp
  800d2d:	68 66 0d 80 00       	push   $0x800d66
  800d32:	6a 00                	push   $0x0
  800d34:	e8 13 ff ff ff       	call   800c4c <sys_env_set_pgfault_upcall>
		if (r < 0)
  800d39:	83 c4 10             	add    $0x10,%esp
  800d3c:	85 c0                	test   %eax,%eax
  800d3e:	79 c1                	jns    800d01 <set_pgfault_handler+0xf>
			cprintf("sys_env_set_pgfault_upcall: %d\n", r);
  800d40:	83 ec 08             	sub    $0x8,%esp
  800d43:	50                   	push   %eax
  800d44:	68 c4 12 80 00       	push   $0x8012c4
  800d49:	e8 1f f4 ff ff       	call   80016d <cprintf>
  800d4e:	83 c4 10             	add    $0x10,%esp
  800d51:	eb ae                	jmp    800d01 <set_pgfault_handler+0xf>
			cprintf("sys_page_alloc: %d\n", r);
  800d53:	83 ec 08             	sub    $0x8,%esp
  800d56:	50                   	push   %eax
  800d57:	68 af 12 80 00       	push   $0x8012af
  800d5c:	e8 0c f4 ff ff       	call   80016d <cprintf>
  800d61:	83 c4 10             	add    $0x10,%esp
  800d64:	eb c4                	jmp    800d2a <set_pgfault_handler+0x38>

00800d66 <_pgfault_upcall>:
...
_pgfault_upcall:
  ...
  800d67:	a1 08 20 80 00       	mov    0x802008,%eax
	call *%eax
  800d6c:	ff d0                	call   *%eax
	addl $4, %esp			// pop function argument
  800d6e:	83 c4 04             	add    $0x4,%esp
	...
	movl 0x28(%esp), %ebx
  800d71:	8b 5c 24 28          	mov    0x28(%esp),%ebx
	movl 0x30(%esp), %ecx
  800d75:	8b 4c 24 30          	mov    0x30(%esp),%ecx
	subl $0x4, %ecx
  800d79:	83 e9 04             	sub    $0x4,%ecx
	movl %ebx, (%ecx)
  800d7c:	89 19                	mov    %ebx,(%ecx)
	movl %ecx, 0x30(%esp)
  800d7e:	89 4c 24 30          	mov    %ecx,0x30(%esp)

	// Restore the trap-time registers.  After you do this, you
	// can no longer modify any general-purpose registers.
	// LAB 4: Your code here.
	addl $0x8, %esp
  800d82:	83 c4 08             	add    $0x8,%esp
	popal
  800d85:	61                   	popa   
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800d90:	53                   	push   %ebx
	...
	va_start(ap, fmt);
  800d91:	8d 5d 14             	lea    0x14(%ebp),%ebx

	// Print the panic message
	cprintf("[%08x] user panic in %s at %s:%d: ",
  800d94:	8b 35 00 20 80 00    	mov    0x802000,%esi
  800d9a:	e8 66 fd ff ff       	call   800b05 <sys_getenvid>
  800d9f:	83 ec 0c             	sub    $0xc,%esp
  800da2:	ff 75 0c             	push   0xc(%ebp)
  800da5:	ff 75 08             	push   0x8(%ebp)
  800da8:	56                   	push   %esi
  800da9:	50                   	push   %eax
  800daa:	68 e4 12 80 00       	push   $0x8012e4
  800daf:	e8 b9 f3 ff ff       	call   80016d <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800db4:	83 c4 18             	add    $0x18,%esp
  800db7:	53                   	push   %ebx
  800db8:	ff 75 10             	push   0x10(%ebp)
  800dbb:	e8 5c f3 ff ff       	call   80011c <vcprintf>
	cprintf("\n");
  800dc0:	c7 04 24 c1 12 80 00 	movl   $0x8012c1,(%esp)
  800dc7:	e8 a1 f3 ff ff       	call   80016d <cprintf>
  800dcc:	83 c4 10             	add    $0x10,%esp
	...
	while (1)
		asm volatile("int3");
  800dcf:	cc                   	int3   
  800dd0:	eb fd                	jmp    800dcf <_panic+0x43>
