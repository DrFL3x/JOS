...
umain(int argc, char **argv)
{
  ...
  800070:	50                   	push   %eax
  800071:	e8 00 0d 00 00       	call   800d76 <ipc_send>
...
sys_env_destroy(envid_t envid)
{
  ...
  800b21:	e8 dd 02 00 00       	call   800e03 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800ba2:	e8 5c 02 00 00       	call   800e03 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800be4:	e8 1a 02 00 00       	call   800e03 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800c26:	e8 d8 01 00 00       	call   800e03 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800c68:	e8 96 01 00 00       	call   800e03 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800caa:	e8 54 01 00 00       	call   800e03 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800d0e:	e8 f0 00 00 00       	call   800e03 <_panic>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  800d39:	74 0b                	je     800d46 <ipc_recv+0x33>
		*from_env_store = thisenv->env_ipc_from;
  800d3b:	8b 15 04 20 80 00    	mov    0x802004,%edx
  800d41:	8b 52 74             	mov    0x74(%edx),%edx
  800d44:	89 16                	mov    %edx,(%esi)
	}

	if (perm_store) {
  800d46:	85 db                	test   %ebx,%ebx
  800d48:	74 0b                	je     800d55 <ipc_recv+0x42>
		*perm_store = thisenv->env_ipc_perm;
  800d4a:	8b 15 04 20 80 00    	mov    0x802004,%edx
  800d50:	8b 52 78             	mov    0x78(%edx),%edx
  800d53:	89 13                	mov    %edx,(%ebx)
	}

	if (r < 0) 
  800d55:	85 c0                	test   %eax,%eax
  800d57:	78 0f                	js     800d68 <ipc_recv+0x55>
		*from_env_store = 0;
		*perm_store = 0;
		return r;
	}
  ...
  800d59:	a1 04 20 80 00       	mov    0x802004,%eax
  ...
  800d67:	c3                   	ret    
		*from_env_store = 0;
  800d68:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
		*perm_store = 0;
  800d6e:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
		return r;
  800d74:	eb eb                	jmp    800d61 <ipc_recv+0x4e>
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  800d8a:	b8 00 00 c0 ee       	mov    $0xeec00000,%eax
  800d8f:	0f 44 d8             	cmove  %eax,%ebx
	// LAB 4: Your code here.
	int r;
	for(;;) {
		r = sys_ipc_try_send(to_env, val, pg ? pg : (void *)UTOP, perm);
  800d92:	ff 75 14             	push   0x14(%ebp)
  800d95:	53                   	push   %ebx
  800d96:	56                   	push   %esi
  800d97:	57                   	push   %edi
  800d98:	e8 12 ff ff ff       	call   800caf <sys_ipc_try_send>
		if (r == 0) {
  800d9d:	83 c4 10             	add    $0x10,%esp
  800da0:	85 c0                	test   %eax,%eax
  800da2:	74 1e                	je     800dc2 <ipc_send+0x4c>
			break;
		} else if (r != -E_IPC_NOT_RECV) {
  800da4:	83 f8 f9             	cmp    $0xfffffff9,%eax
  800da7:	75 07                	jne    800db0 <ipc_send+0x3a>
			panic("ipc_send: %e", r);
		}
		sys_yield();
  800da9:	e8 97 fd ff ff       	call   800b45 <sys_yield>
		r = sys_ipc_try_send(to_env, val, pg ? pg : (void *)UTOP, perm);
  800dae:	eb e2                	jmp    800d92 <ipc_send+0x1c>
			panic("ipc_send: %e", r);
  800db0:	50                   	push   %eax
  800db1:	68 4f 13 80 00       	push   $0x80134f
  800db6:	6a 45                	push   $0x45
  800db8:	68 5c 13 80 00       	push   $0x80135c
  800dbd:	e8 41 00 00 00       	call   800e03 <_panic>
	}
}
...
ipc_find_env(enum EnvType type)
{
  ...
  800de3:	74 11                	je     800df6 <ipc_find_env+0x2c>
	for (i = 0; i < NENV; i++)
  800de5:	83 c0 01             	add    $0x1,%eax
  800de8:	3d 00 04 00 00       	cmp    $0x400,%eax
  800ded:	75 e6                	jne    800dd5 <ipc_find_env+0xb>
			return envs[i].env_id;
	return 0;
  800def:	b8 00 00 00 00       	mov    $0x0,%eax
  800df4:	eb 0b                	jmp    800e01 <ipc_find_env+0x37>
			return envs[i].env_id;
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800e07:	53                   	push   %ebx
	...
	va_start(ap, fmt);
  800e08:	8d 5d 14             	lea    0x14(%ebp),%ebx

	// Print the panic message
	cprintf("[%08x] user panic in %s at %s:%d: ",
  800e0b:	8b 35 00 20 80 00    	mov    0x802000,%esi
  800e11:	e8 10 fd ff ff       	call   800b26 <sys_getenvid>
  800e16:	83 ec 0c             	sub    $0xc,%esp
  800e19:	ff 75 0c             	push   0xc(%ebp)
  800e1c:	ff 75 08             	push   0x8(%ebp)
  800e1f:	56                   	push   %esi
  800e20:	50                   	push   %eax
  800e21:	68 68 13 80 00       	push   $0x801368
  800e26:	e8 63 f3 ff ff       	call   80018e <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800e2b:	83 c4 18             	add    $0x18,%esp
  800e2e:	53                   	push   %ebx
  800e2f:	ff 75 10             	push   0x10(%ebp)
  800e32:	e8 06 f3 ff ff       	call   80013d <vcprintf>
	cprintf("\n");
  800e37:	c7 04 24 af 10 80 00 	movl   $0x8010af,(%esp)
  ...
  800e43:	83 c4 10             	add    $0x10,%esp
	...
	while (1)
		asm volatile("int3");
  800e46:	cc                   	int3   
  800e47:	eb fd                	jmp    800e46 <_panic+0x43>
