...
sys_env_destroy(envid_t envid)
{
  ...
  80010f:	68 6a 0f 80 00       	push   $0x800f6a
  800114:	6a 23                	push   $0x23
  800116:	68 87 0f 80 00       	push   $0x800f87
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800190:	68 6a 0f 80 00       	push   $0x800f6a
  800195:	6a 23                	push   $0x23
  800197:	68 87 0f 80 00       	push   $0x800f87
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8001d2:	68 6a 0f 80 00       	push   $0x800f6a
  8001d7:	6a 23                	push   $0x23
  8001d9:	68 87 0f 80 00       	push   $0x800f87
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800214:	68 6a 0f 80 00       	push   $0x800f6a
  800219:	6a 23                	push   $0x23
  80021b:	68 87 0f 80 00       	push   $0x800f87
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800256:	68 6a 0f 80 00       	push   $0x800f6a
  80025b:	6a 23                	push   $0x23
  80025d:	68 87 0f 80 00       	push   $0x800f87
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800298:	68 6a 0f 80 00       	push   $0x800f6a
  80029d:	6a 23                	push   $0x23
  80029f:	68 87 0f 80 00       	push   $0x800f87
...
sys_ipc_recv(void *dstva)
{
  ...
  8002fc:	68 6a 0f 80 00       	push   $0x800f6a
  800301:	6a 23                	push   $0x23
  800303:	68 87 0f 80 00       	push   $0x800f87
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  80033c:	e8 56 00 00 00       	call   800397 <vcprintf>
	cprintf("\n");
  800341:	c7 04 24 bb 0f 80 00 	movl   $0x800fbb,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800490:	0f be 80 bd 0f 80 00 	movsbl 0x800fbd(%eax),%eax
  800497:	50                   	push   %eax
...
008004df <vprintfmt>:
{
  ...
  800623:	52                   	push   %edx
  800624:	68 de 0f 80 00       	push   $0x800fde
  800629:	53                   	push   %ebx
  80062a:	56                   	push   %esi
  ...
  80063b:	50                   	push   %eax
  80063c:	68 d5 0f 80 00       	push   $0x800fd5
  800641:	53                   	push   %ebx
  800642:	56                   	push   %esi
  ...
  800663:	b8 ce 0f 80 00       	mov    $0x800fce,%eax
