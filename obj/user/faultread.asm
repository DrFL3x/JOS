	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8001e3:	0f be 80 88 0f 80 00 	movsbl 0x800f88(%eax),%eax
  8001ea:	50                   	push   %eax
...
00800232 <vprintfmt>:
{
  ...
  80029d:	ff 24 85 40 10 80 00 	jmp    *0x801040(,%eax,4)
  ...
  80036b:	8b 14 85 a0 11 80 00 	mov    0x8011a0(,%eax,4),%edx
  800372:	85 d2                	test   %edx,%edx
  800374:	74 18                	je     80038e <vprintfmt+0x15c>
				printfmt(putch, putdat, "%s", p);
  800376:	52                   	push   %edx
  800377:	68 a9 0f 80 00       	push   $0x800fa9
  80037c:	53                   	push   %ebx
  80037d:	56                   	push   %esi
  ...
  80038e:	50                   	push   %eax
  80038f:	68 a0 0f 80 00       	push   $0x800fa0
  800394:	53                   	push   %ebx
  800395:	56                   	push   %esi
  ...
  8003b6:	b8 99 0f 80 00       	mov    $0x800f99,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800ac2:	68 c4 11 80 00       	push   $0x8011c4
  800ac7:	6a 23                	push   $0x23
  800ac9:	68 e1 11 80 00       	push   $0x8011e1
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800b43:	68 c4 11 80 00       	push   $0x8011c4
  800b48:	6a 23                	push   $0x23
  800b4a:	68 e1 11 80 00       	push   $0x8011e1
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800b85:	68 c4 11 80 00       	push   $0x8011c4
  800b8a:	6a 23                	push   $0x23
  800b8c:	68 e1 11 80 00       	push   $0x8011e1
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800bc7:	68 c4 11 80 00       	push   $0x8011c4
  800bcc:	6a 23                	push   $0x23
  800bce:	68 e1 11 80 00       	push   $0x8011e1
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800c09:	68 c4 11 80 00       	push   $0x8011c4
  800c0e:	6a 23                	push   $0x23
  800c10:	68 e1 11 80 00       	push   $0x8011e1
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800c4b:	68 c4 11 80 00       	push   $0x8011c4
  800c50:	6a 23                	push   $0x23
  800c52:	68 e1 11 80 00       	push   $0x8011e1
...
sys_ipc_recv(void *dstva)
{
  ...
  800caf:	68 c4 11 80 00       	push   $0x8011c4
  800cb4:	6a 23                	push   $0x23
  800cb6:	68 e1 11 80 00       	push   $0x8011e1
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800cdc:	56                   	push   %esi
  800cdd:	50                   	push   %eax
  800cde:	68 f0 11 80 00       	push   $0x8011f0
  ...
  800cef:	e8 f6 f3 ff ff       	call   8000ea <vcprintf>
	cprintf("\n");
  800cf4:	c7 04 24 7c 0f 80 00 	movl   $0x800f7c,(%esp)
