...
//static struct Env envs[NENV]; // array of Env process structures
...
page_init(void)
{
	...
	//int nextfree = (PADDR((uint32_t)boot_alloc(0)) / PGSIZE;
...
struct PageInfo *page_alloc(int alloc_flags)
{
	...
	// return NULL not neccesary, mistake ..new page is already NULL
...
pgdir_walk(pde_t *pgdir, const void *va, int create) // reviewwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww 
{
	...
	struct PageInfo *new_page=NULL ; // new page we allocate
	pte_t *pointer_table_page_index=NULL; // pte
