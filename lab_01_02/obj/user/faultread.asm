	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80024d:	0f be 84 03 ac ee ff 	movsbl -0x1154(%ebx,%eax,1),%eax
  800254:	ff 
  800255:	50                   	push   %eax
...
0080029d <vprintfmt>:
{
  ...
  800329:	03 b4 81 3c ef ff ff 	add    -0x10c4(%ecx,%eax,4),%esi
...
008003ec <.L28>:
  ...
  800411:	8d 80 cd ee ff ff    	lea    -0x1133(%eax),%eax
  800417:	50                   	push   %eax
  800418:	57                   	push   %edi
  800419:	56                   	push   %esi
  ...
  80042e:	8d 80 c4 ee ff ff    	lea    -0x113c(%eax),%eax
  800434:	50                   	push   %eax
  800435:	57                   	push   %edi
  800436:	56                   	push   %esi
...
00800447 <.L24>:
  ...
  80045d:	8d 80 bd ee ff ff    	lea    -0x1143(%eax),%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800bba:	8d 83 94 f0 ff ff    	lea    -0xf6c(%ebx),%eax
  800bc0:	50                   	push   %eax
  800bc1:	6a 23                	push   $0x23
  800bc3:	8d 83 b1 f0 ff ff    	lea    -0xf4f(%ebx),%eax
  800bc9:	50                   	push   %eax
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800c1b:	57                   	push   %edi
  800c1c:	50                   	push   %eax
  800c1d:	8d 83 c0 f0 ff ff    	lea    -0xf40(%ebx),%eax
  800c23:	50                   	push   %eax
  ...
  800c30:	e8 fa f4 ff ff       	call   80012f <vcprintf>
	cprintf("\n");
  800c35:	8d 83 a0 ee ff ff    	lea    -0x1160(%ebx),%eax
